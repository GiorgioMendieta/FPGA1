...
entity FSM is
  ...
  (
    ...
    Seuil : in std_logic_vector (27 downto 0);  -- Seuil du Compteur pour Vitesse Clignotement
...
architecture Behavioral of FSM is
  ...
  signal cpt : integer range 0 to 100000000; -- Compteur de Temporisation
...
begin
  ...
  begin
    ...
    if Reset = '1' then
      ...
      if ((EP = CLIGN_OFF) or (EP = CLIGN_ON)) and (Cpt < Seuil) then
        Cpt <= Cpt + 1;
